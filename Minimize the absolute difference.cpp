...
sorted we start from the largest possible values of a,b,c which are the last elements of each array now at every step the possible ways
...
at every stage keep updating the ans.
***************************************************************************************************************************************/
